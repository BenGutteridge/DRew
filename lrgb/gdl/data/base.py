...
class BaseDataset(InMemoryDataset):
    ...
    def to_dataset(self, base, edge_index, edge_attr):
        data = Data(
            ...
            y=base.y,
            # train_mask=torch.zeros(base.train_mask.size()[0], dtype=torch.bool),
            # test_mask=torch.zeros(base.test_mask.size()[0], dtype=torch.bool),
            # val_mask=torch.zeros(base.val_mask.size()[0], dtype=torch.bool),
        )
