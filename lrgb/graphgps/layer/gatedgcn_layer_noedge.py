...
class GatedGCNLayer(pyg_nn.conv.MessagePassing):
    """
        ...
        Standard GatedGCN layer with edge features removed.
    ...
    def aggregate(self, sigma_ij, index, Bx_j, Bx):
        ...
        sum_sigma_x = sigma_ij * Bx_j # every single edge
        numerator_eta_xj = scatter(sum_sigma_x, index, 0, None, dim_size,
                                   reduce='sum') # reduces to link j->i
...
register_layer('gatedgcnconv_noedge', GatedGCNGraphGymLayer)
